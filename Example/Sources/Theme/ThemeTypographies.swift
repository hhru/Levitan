...
struct ThemeTypographies: Sendable {
    ...
    let title3 = TypographyToken(
        font: .system(
            weight: .semibold,
            size: 28.0,
            scale: FontScaleToken(textStyle: .title3)
        ),
        letterSpacing: -0.35,
        lineHeight: 40.0
    )
    ...
    let label1 = TypographyToken(
        font: .system(
            weight: .regular,
            size: 18.0,
            scale: FontScaleToken(textStyle: .title1)
        ),
        letterSpacing: -0.09,
        lineHeight: 26.0
    )
    ...
    let label2 = TypographyToken(
        font: .system(
            weight: .regular,
            size: 16.0,
            scale: FontScaleToken(textStyle: .title2)
        ),
        letterSpacing: 0.0,
        lineHeight: 22.0
    )
    ...
    let paragraph2 = TypographyToken(
        font: .system(
            weight: .regular,
            size: 16.0,
            scale: FontScaleToken(textStyle: .body)
        ),
        letterSpacing: 0.08,
        lineHeight: 26.0
    )
