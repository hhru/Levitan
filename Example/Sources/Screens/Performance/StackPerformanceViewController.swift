...
final class StackPerformanceViewController: UIHostingController<AnyView> {
...
extension StackPerformanceViewController {
    ...
    private func updateContentView() {
        ...
        let content = ScrollView {
            LazyVStack(spacing: .zero) {
                ForEach(Array(users.enumerated()), id: \.element.id) { [weak self] index, user in
                    self?.userItem(
                        user: user,
