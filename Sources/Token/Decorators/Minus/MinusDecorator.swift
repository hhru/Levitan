...
internal struct MinusDecorator<Value: DecorableByMinus & TokenValue>: TokenDecorator {
...
extension Token: DecorableByMinus where Value: DecorableByMinus & TokenValue {
