...
///
/// Любой UI-компонент, соответствующий этом протоколу `Component`,
...
/// но в реальном приложении рекомендуется создаваться его на уровне корневого компонента
/// и передаваться по цепочке в иерархии компонентов.
///
///
