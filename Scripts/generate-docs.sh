...
readonly target_name="Levitan iOS"
readonly derived_data_path="DerivedData"
readonly docs_path="docs"
readonly docarchive_file_path="${derived_data_path}/Build/Products/Debug-iphonesimulator/Levitan.doccarchive"
readonly url_base_path="Levitan"
